...
router.get("/commerce-add", middlewares.ManagerMiddleware, commereceController.GetAddCommerece);
router.post("/commerce-add", middlewares.ManagerMiddleware, commereceController.PostAddCommerece);
