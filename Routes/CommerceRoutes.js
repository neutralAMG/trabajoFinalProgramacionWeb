...
router.get("/commerce-add", middlewares.CommereceMiddleware, commereceController.GetAddCommerece);
router.post("/commerce-add", middlewares.CommereceMiddleware, commereceController.PostAddCommerece);
